...
[n, t, d] = xlsread('F:\Data mining\Incomplete+Datasets\CATAGORICAL\TTTTEG\Blend1.xlsx');
...
xlswrite(strcat('train_data', 'Blend1'),tt);
...
% end
 letter1 = tt;
%[missing_data,missing_txt] = xlsread( fullfile(fpath,fname));
[n, t, letter2] = xlsread('F:\Data mining\Original+Datasets\TTTTEG.xlsx');
[R,C] = size(letter1)
sum = 0;
% 
for i=1:R
