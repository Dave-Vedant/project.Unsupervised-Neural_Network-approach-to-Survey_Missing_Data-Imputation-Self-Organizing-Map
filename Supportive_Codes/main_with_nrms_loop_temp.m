...
%     d = xlsread('F:\Data mining\Incomplete+Datasets\4-gauss\Med10.xlsx');
    ...
    %while 1   
        ...
        %end
        xlswrite(strcat('cpy_DERM_', name),train_data);
        [win_Row,win_Col];
...
%             train_data(missr(i),missc(i)) = somMap(win_Row, win_Col,missc(i));
        ...
        original= xlsread('I:\DM\Final Demo\Datasets\Original+Datasets\DERM.xlsx');
    ...
    xlswrite(strcat('train_DERM_', name),train_data);
    %clear all;
